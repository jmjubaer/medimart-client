        ...
        <section className='relative h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden'>
            ...
            <div className='container relative z-10 text-center px-4 max-w-5xl mx-auto'>
                ...
                <p className='sm:text-xl text-base md:text-2xl text-white/90 mb-5 sm:mb-10 max-w-3xl mx-auto leading-relaxed'>
                    ...
                    healthcare accessible, affordable, and convenient for
                    everyone.
                </p>
                <div className='flex flex-col sm:flex-row gap-5 justify-center'>
                    <a
                        href='#mission'
                        className='px-10 py-2 sm:py-4 bg-white text-cyan-600 rounded-full font-medium hover:bg-cyan-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 flex items-center justify-center gap-2 group'>
                        Our Mission
                    </a>
                    <a
                        href='#team'
                        className='px-8 py-2 sm:py-4 bg-transparent border-2 border-white text-white rounded-full font-medium hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2 group'>
                        Meet Our Team
                    </a>
                </div>
            </div>
