    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-white">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">Setting new standards in healthcare delivery</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-24">
          {goals.map((goal, index) => (
            ...
            >
              ...
              <div className="text-white/90 text-lg">{goal.label}</div>
            </div>
          ))}
        </div>

        <div className="text-center mb-20">
          <h3 className="text-3xl md:text-4xl font-bold mb-12">Certifications We are Pursuing</h3>
