...
const LoginForm = () => {
    ...
    return (
        <div
            ...
            className={` bg-cover py-24 text-black flex justify-center min-h-screen item-center relative`}>
            {/* Overlay */}
            <div className='absolute inset-0 bg-black/60 z-0 py-24'></div>
            <div className=' lg:my-0 bg-white/90 backdrop-blur-xs mx-5 relative z-10'>
                <div className='w-full flex justify-center'>
                    <div className=' space-y-4 md:space-y-6  w-full p-3 xs:p-8'>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className='space-y-4 md:space-y-6  '>
                                ...
                                <button
                                    type='submit'
                                    className='w-full bg-primary text-white py-1 xs:py-2 rounded-lg sm:text-xl font-medium sm:mt-4'>
                                    {isSubmitting ? "Signing..." : "Sign In"}
                                </button>
                                <Link href={"/register"}>
                                    <p className='text-sm font-light text-gray-950 '>
                                        Don’t have an account yet?
                                        <span className='font-medium hover:underline text-blue-500 ml-1'>
                                            Sign up
                                        </span>
                                    </p>
                                </Link>
