  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="container py-10 px-4 md:px-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Medicine Shop</h1>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-72 shrink-0">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden sticky top-24">
              ...
              <div className="p-5 border-b border-gray-100">
                <h4 className="font-medium mb-3 text-gray-700">Search</h4>
              ...
              <div className="p-5 border-b border-gray-100">
                <h4 className="font-medium mb-3 text-gray-700">Prescription</h4>
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <div className="relative">
                    <input
                      onChange={() =>
                        setRequiredPrescription(!requiredPrescription)
                      }
                      type="checkbox"
          ...
          <div className="flex-1">
            {loading && medicines.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {sortedMedicines.map((medicine: IMedicine, index: number) => (
                  <div
                    key={`${medicine._id}-${index}`}
                    ref={
                      index === sortedMedicines.length - 1
                    ...
                    <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                      ...
                      <div className="p-4 flex-grow flex flex-col">
                        ...
                        <button
                          ...
                          className={`flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg transition-all font-medium text-sm w-full ${
                            medicine.quantity > 0
            ...
            {!hasMore && medicines.length > 0 && (
              <div className="text-center text-gray-500 py-8 bg-white rounded-lg mt-6 shadow-sm">
                ...
                <p className="text-sm">No more medicines to load</p>
              </div>
            )}
          </div>
        </div>
